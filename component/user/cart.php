...
<body class="w-full flex flex-col justify-center items-center select-none font-alata">
    <nav class="w-full h-16 mb-8 flex justify-between items-center px-5">
        <div class="text-white">
            <a href="./user-menu.php" class="fa-solid fa-bars  font-bold text-lg font-sans mr-4 hover:bg-coklat3 py-3 px-3 rounded-lg bg-coklat2"></a>
        </div>
        <div>
            <a href="cart.php" class="fa-solid fa-cart-shopping font-bold text-lg mr-4 hover:bg-neutral-700 py-4 px-3 border text-white bg-black"></a>
    ...
    <div class="container w-full h-full flex justify-center items-center">
        <div class="w-full h-full flex flex-col justify- items-center">
            <h1 class="font-bold text-xl">Keranjang <?php $_SESSION["user"]; ?></h1>
            <table class="table-auto border-black border w-3/6 text-center my-4 shadow-lg">
                <thead>
                    <tr class="text-lg">
                ...
                <form method="post" action="" class="w-full h-full">
                    ...
                    <div class="w-full h-full flex justify-end items-end mb-2">
                        <button class="py-2 px-6 bg-coklat2 hover:bg-coklat3 duration-300 rounded font-bold text-lg text-white" name="transaction" type="submit">
                            Pesan
                        </button>
                    </div>
                </form>
